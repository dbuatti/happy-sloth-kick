...
export default function TasksPage() {
  ...
  const {
    sections,
    addSection, // Kept for potential future use, though not directly used here
    updateSection, // Kept for potential future use, though not directly used here
    deleteSection,
  ...
  const handleSaveTask = async (task: Task) => {
    if (task.id) {
      // For updating, we only send the fields that can be updated, excluding id, user_id, created_at
      const { id, user_id, created_at, ...updates } = task;
      await updateTask(id, updates);
    } else {
      // For adding, we omit id, user_id, created_at as they are generated by Supabase
              ...
              {(provided: DroppableProvided) => (
                ...
                >
                  <SectionHeader
                    ...
                    onToggleFocusMode={(id: string, include: boolean) => updateSectionIncludeInFocusMode(id, include)}
                  />
