...
import {
  Plus, GripVertical, Edit, Trash2, ChevronLeft, ChevronRight, Search, Filter, Settings, ListTodo, Info, Star, AlertCircle, Loader2, Tag
} from 'lucide-react';
          ...
          <Dialog open={isAddSectionDialogOpen} onOpenChange={setIsAddSectionDialogOpen}>
            <DialogTrigger asChild>
              <Button variant="outline" className="flex-shrink-0">
                <ListTodo className="mr-2 h-4 w-4" /> Add Section
              </Button>
            </DialogTrigger>
            <DialogContent className="sm:max-w-[425px]">
              <DialogHeader>
