...
import { Edit, Trash2, MoreVertical, Plus, Link as LinkIcon, Image as ImageIcon, StickyNote, BellRing, Repeat, ListTodo, Eye, EyeOff, Archive, RotateCcw, X, Calendar as CalendarIcon, CheckCircle2 } from 'lucide-react';
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuTrigger, DropdownMenuSeparator } from '@/components/ui/dropdown-menu';
import { Checkbox } from '@/components/ui/checkbox';
import { cn } from "@/lib/utils";
import { Task, TaskCategory, TaskSection, UpdateTaskData, NewTaskData, Appointment, DoTodayOffLogEntry, TaskStatus, TaskItemProps } from '@/types';
...
const TaskItem: React.FC<TaskItemProps> = ({
  ...
  return (
    <>
      <div
        className={cn(
          "flex items-center p-2 rounded-md border bg-card text-card-foreground shadow-sm",
