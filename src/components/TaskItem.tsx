...
interface TaskItemProps {
  ...
  // Removed allCategories: Category[]; // Not directly used in TaskItem
  ...
  // Removed doTodayOffIds: Set<string>; // Not directly used in TaskItem
  ...
  // Removed index: number; // Not directly used in TaskItem
}
