...
interface TaskReorderDialogProps {
  ...
  // Removed allCategories: Category[]; // Not directly used in TaskReorderDialog
...
const SortableTaskReorderItem: React.FC<{
  ...
  // Removed index: number; // Not directly used in SortableTaskReorderItem
...
const TaskReorderDialog: React.FC<TaskReorderDialogProps> = ({
  ...
  onDeleteTask,
  sections,
  // Removed allCategories, // No longer needed here
  onOpenOverview,
  currentDate,
  setFocusTask,
  doTodayOffIds,
            ...
            <ul className="space-y-2">
              {localTasks.map((task) => ( // Removed index
                <SortableTaskReorderItem
                  ...
                  sections={sections}
                  // Removed allCategories={allCategories} // No longer passed to SortableTaskReorderItem
                  ...
                  // Removed index={index} // No longer passed to SortableTaskReorderItem
                />
              ))}
            </ul>
          </SortableContext>
            ...
            <DragOverlay dropAnimation={null}>
              {activeTask ? (
                <SortableTaskReorderItem
                  ...
                  isOverlay={true}
                  isDropTarget={false}
                  // Removed index={0} // No longer passed to SortableTaskReorderItem
                />
              ) : null}
            </DragOverlay>,
            document.body
