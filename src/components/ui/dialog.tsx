...
import type { ElementRef, ComponentPropsWithoutRef, HTMLAttributes } from 'react'; // Import types
...
const DialogOverlay = React.forwardRef<
  ElementRef<typeof DialogPrimitives.Overlay>, // Use ElementRef
  ComponentPropsWithoutRef<typeof DialogPrimitives.Overlay> // Use ComponentPropsWithoutRef
>(({ className, ...props }, ref) => (
...
const DialogContent = React.forwardRef<
  ElementRef<typeof DialogPrimitives.Content>, // Use ElementRef
  ComponentPropsWithoutRef<typeof DialogPrimitives.Content> // Use ComponentPropsWithoutRef
...
const DialogHeader = ({
  className,
  ...props
}: HTMLAttributes<HTMLDivElement>) => ( // Use HTMLAttributes
  <div
    className={cn(
...
const DialogTitle = React.forwardRef<
  ElementRef<typeof DialogPrimitives.Title>, // Use ElementRef
  ComponentPropsWithoutRef<typeof DialogPrimitives.Title> // Use ComponentPropsWithoutRef
>(({ className, ...props }, ref) => (
...
const DialogDescription = React.forwardRef<
  ElementRef<typeof DialogPrimitives.Description>, // Use ElementRef
  ComponentPropsWithoutRef<typeof DialogPrimitives.Description> // Use ComponentPropsWithoutRef
>(({ className, ...props }, ref) => (
