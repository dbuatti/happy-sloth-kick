...
export type CalendarProps = HTMLAttributes<HTMLDivElement> & ComponentProps<typeof DayPicker>;
...
function Calendar({
  ...
  return (
    <div
      ...
      {...(props as HTMLAttributes<HTMLDivElement>)} // Cast props to HTMLAttributes<HTMLDivElement>
    >
      <DayPicker
